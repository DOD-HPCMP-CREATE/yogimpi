...
mpiConstants = [ 'MPI_VERSION', 'MPI_SUBVERSION',
    ...
    'MPI_LOGICAL', 'MPI_2REAL', 'MPI_2DOUBLE_PRECISION', 'MPI_2INTEGER',
    ...
    'MPI_UNEQUAL', 'MPI_TAG_UB', 'MPI_IO', 'MPI_HOST', 'MPI_WTIME_IS_GLOBAL',
    'MPI_MAX', 'MPI_MIN', 'MPI_SUM', 'MPI_PROD', 'MPI_MAXLOC', 'MPI_MINLOC',
    'MPI_BAND', 'MPI_BOR', 'MPI_BXOR', 'MPI_LAND', 'MPI_LOR', 'MPI_LXOR',
    'MPI_GROUP_NULL', 'MPI_COMM_NULL', 'MPI_DATATYPE_NULL', 'MPI_REQUEST_NULL',
    'MPI_OP_NULL', 'MPI_INFO_NULL', 'MPI_FILE_NULL', 'MPI_ERRHANDLER_NULL',
    'MPI_WIN_NULL', 'MPI_ERRORS_ARE_FATAL', 'MPI_ERRORS_RETURN',
    'MPI_GROUP_EMPTY', 'MPI_THREAD_SINGLE', 'MPI_THREAD_FUNNELED',
    'MPI_THREAD_SERIALIZED', 'MPI_THREAD_MULTIPLE', 'MPI_LOCK_EXCLUSIVE',
    'MPI_LOCK_SHARED', 'MPI_GRAPH', 'MPI_CART', 'MPI_COMBINER_NAMED',
    'MPI_COMBINER_DUP', 'MPI_COMBINER_CONTIGUOUS', 'MPI_COMBINER_VECTOR',
    ...
    'MPI_COMBINER_RESIZED', 'MPI_COMM_TYPE_SHARED', 'MPI_STATUS_SIZE',
    'MPI_SOURCE', 'MPI_TAG', 'MPI_ERROR', 'MPI_STATUS_IGNORE',
    'MPI_STATUSES_IGNORE', 'MPI_IN_PLACE'
    ]
...
'MPI_Comm_call_errhandler', 'MPI_Comm_compare', 'MPI_Comm_create',
'MPI_Comm_create_errhandler', 'MPI_Comm_create_keyval', 'MPI_Comm_delete_attr',
